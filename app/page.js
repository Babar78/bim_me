...
export default function Home() {
  return (
    <>
      <NightSkyBackground />
      <main className="bg-black h-screen flex flex-col w-full z-[100]">
        <Navbar />
        <div className="flex-1 h-full flex justify-center items-center">
          <div className="h-fit text-center max-w-[1000px] flex flex-col justify-between min-h-[500px] px-2">
            ...
            <div className="w-full flex md:flex-row flex-col gap-5 items-center">
              ...
              <Button variant="contained" color="primary" className="bg-gradientPattern rounded-lg w-fit">Generate &nbsp; <AutoAwesomeIcon fontSize="16" /></Button>
            </div>
          </div>
        </div>
      </main>
